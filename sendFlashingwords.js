...
async function sendFlashingwords(source_group_id, id, text) { 
    ...
    if (view_json[id]) {
        ...
        let body = {
            "1": { "2": { "1": source_group_id } }, "2": { "1": 1, "2": 0, "3": 0 }, "3": { "1": { "2": [{ "1": { "1": "ID错误" } }, { "37": { "1": 165, "17": 21908, "19": { "15": 65536, "31": 0, "41": 0 } } }] } }, "4": crypto.randomBytes(2).readUInt16BE(),"5": crypto.randomBytes(4).readUInt32BE(),  "8": 1 }
        body = core.pb.encode(body)
        await bot.sendUni("MessageSvc.PbSendMsg", body);
    }
}
