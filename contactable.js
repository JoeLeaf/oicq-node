...
const { pb } = require( "../core")
const errors_1 = require("../errors");
const common_1 = require("../common");
const { escapeXml,timestamp, uuid, gzip } = require("../common");
const message_1 = require("../message");
const {  PrivateMessage,  Converter, rand2uuid } = require("../message");
...
async function getPttBuffer(file, ffmpeg = "ffmpeg") {
    if (file instanceof Buffer || file.startsWith("base64://")) {
        ...
        if (head.includes("SILK") || head.includes("AMR") || true) {
            return buf;
        }
        else {
